class monaimodel:
    ...
    # Import the necessary transformations from the MONAI library
        ...
        model.load_state_dict(torch.load("D:/Pooja/Project School-2/Mern/mernweb/The Fast API App/best_metric_model.pth", map_location=torch.device('cpu')))
        ...
        # Load the STL file
        stl_file = r"D:/Pooja/Project School-2/Mern/mernweb/The Fast API App/combined_output.stl"
        mesh = trimesh.load_mesh(stl_file)

        # Save the mesh as an OBJ file in the Kaggle working directory
        obj_file = r"D:/Pooja/Project School-2/Mern/mernweb/The Fast API App/lungs_obj_pred.obj"
