...
class HeartModel:
    ...
    def heart_pred(self, input_image_path):
        ...
        model_path = str(Path(r"D:/Pooja/Project School-2/Mern/mernweb/The Fast API App/Heart_best_metric.pt"))
        if not os.path.exists(r'out_Heart/'):
            os.makedirs(r'out_Heart/')
        result_path = r'out_Heart/'
        ...
        print("saved results")
        self.convert_obj('D:/Pooja/Project School-2/Mern/mernweb/The Fast API App/out_Heart/prediction/pred_heart.nii.gz')
    ...
    def convert_obj(self, nii_path):
        ...
        output_obj="D:/Pooja/Project School-2/Mern/mernweb/The Fast API App/heart_obj_pred.obj"
